...
class pascal_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        self._classes = ('__background__',  # always index 0
                         'TextView','CheckBox', 'ImgButton', 'Button', 'EditText','ImgView','CheckedTextView','ProgressBar','RadioButton','RatingBar','SeekBar','Switch','ProgressBarHorizontal')
    ...
    def _load_rpn_roidb(self, gt_roidb):
        ...
        assert os.path.exists(fiilename), \
